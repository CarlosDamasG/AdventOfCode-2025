...
int RollosPapelValidos(std::vector<std::vector<char>> matriz, int validos) {
  std::vector<std::vector<char>> copia_matriz = matriz;
  ...
  if (rollos_papel_validos > 0) {
    rollos_papel_validos += RollosPapelValidos(copia_matriz, rollos_papel_validos);
  } 
...
int main(int argc, char* argv[]) {
  ...
  int rollos_papel = RollosPapelValidos(matriz, 0);
